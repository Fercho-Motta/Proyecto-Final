...
public class clsPosiblesClientes {
    ...
    public int getInCatidadEmpleados() {
        return inCatidadEmpleados;
    }

    public void setInCatidadEmpleados(int inCatidadEmpleados) {
        this.inCatidadEmpleados = inCatidadEmpleados;
    }
    ...
    public char getChNlNoParticipacionCorreoElectronico() {
        return chNoParticipacionCorreoElectronico;
    }

    public void setChNlNoParticipacionCorreoElectronico(char chNoParticipacionCorreoElectronico) {
